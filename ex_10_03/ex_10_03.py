...
# Remove numbers, punctuation, and set all to lowercase
for line in fhand:
...
for key, val in list(dictionary_counts.items()):
    # Computes the relative frequency of each letter
    relative_lst.append(((val / counts)*100, key))    

relative_lst.sort(reverse=True)                 # Sort for highest frequency
